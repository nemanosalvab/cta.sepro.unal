...
// load the data
d3.json("https://nemanosalvab.carto.com/api/v2/sql?q=select "+ producto +",amun_nom_1 from table_2013_1 where mango >0 order by "+ producto +" ASC  &api_key=947d3ad4f49905b235eb9cd8b071ea40ae9faa94", function(error, data) {
